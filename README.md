# irxOS — A web-based agentic AI OS

This project is a fork from [ryOS](https://github.com/ryokun6/ryos)
...
- **Chats**: AI-powered chat with speech & tool calling
  ...
  - irxOS FM DJ mode - when music plays, Irsyad becomes a radio DJ
