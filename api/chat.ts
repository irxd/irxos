  ...
  try {
    ...
    const result = streamText({
      ...
      tools: {
        launchApp: {
          description:
            "Launch an application in the irxOS interface when the user explicitly requests it. If the id is 'internet-explorer', you must provide BOTH a real 'url' and a 'year' for time-travel; otherwise provide neither.",
          parameters: z
            .object({
        ...
        closeApp: {
          description:
            "Close an application in the irxOS interface—but only when the user explicitly asks you to close that specific app.",
          parameters: z.object({
        ...
        switchTheme: {
          description:
            "Switch the irxOS UI theme to a specific OS style when the user explicitly requests it.",
          parameters: z.object({
            theme: z
              .enum(themeIds)
              .describe(
